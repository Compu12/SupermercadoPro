...
public class ReporteCliente extends javax.swing.JInternalFrame {
   ...
   ResultSet r;
    ...
    try{
     ...
     this.JT_TablaReporteClientes.setModel(tabla);
    ...
    private void initComponents() {
        ...
        JT_TablaReporteClientes = new javax.swing.JTable();
        ...
        JT_TablaReporteClientes.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        JT_TablaReporteClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(JT_TablaReporteClientes);
    ...
    private void JBT_ImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBT_ImprimirActionPerformed
        ...
        cn=DriverManager.getConnection("jdbc:odbc:conexion");
         JasperReport reportes = JasperCompileManager.compileReport("reporteclientes1.jrxml");
    ...
    private javax.swing.JTable JT_TablaReporteClientes;
